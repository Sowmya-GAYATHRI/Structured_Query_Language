...
VALUES ('MOV-0707', 'EEGA', 'Action', 'Telugu', 154, 'Rajmouli');
...
VALUES ('MOv-0909', 'The Game', 'Action Drama', 'Telugu', '2026-09-24', 173, 'Srikanth Odela', 'ADULT', 8.5, 900000000.00, 'RELEASED');

INSERT INTO MOVIES (movie_code, title, genre, original_language, duration_minutes, director_name) 
VALUES ('MOV-009808', 'Godhavari', 'Action', 'Telugu', 154, 'Shekharkamal');
